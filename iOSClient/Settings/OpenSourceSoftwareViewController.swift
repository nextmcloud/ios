//
//  OpenSourceSoftwareViewController.swift
//  Nextcloud
//
...
class OpenSourceSoftwareViewController: UIViewController, WKNavigationDelegate, WKUIDelegate {
    ...
    override func viewDidLoad() {
        ...
        let myURL = URL(string: "https://static.magentacloud.de/licences/ios.html")

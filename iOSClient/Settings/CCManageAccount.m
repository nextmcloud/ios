...
- (void)initializeForm
{
    ...
    NSArray *accounts = [[NCManageDatabase shared] getAllTableAccount];
    ...
    for (tableAccount *account in accounts) {
        ...
        // Avatar
        UIImage *avatar = [[[NCUtility alloc] init] loadUserImageFor:account.user displayName:account.displayName urlBase:account.urlBase];
...
-(void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (editingStyle == UITableViewCellEditingStyleDelete) {
        ...
        tableAccount *tableActiveAccount = [[NCManageDatabase shared] getActiveTableAccount];

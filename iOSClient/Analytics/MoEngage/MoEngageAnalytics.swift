...
//    // Handles custom actions sent from MoEngage Dashboard
//    func handleCustomAction(_ actionDict: [AnyHashable: Any]) {
//        if let action = actionDict["show-native-rating"] as? String,
//           action.lowercased() == "true" {

...
class NCContextMenuTrash: NSObject {
    ...
    func viewMenu() -> UIMenu {
        ...
        let restoreAction = UIAction(
            ...
            image: utility.loadImage(named: "restore", colors: [NCBrandColor.shared.iconImageColor])
        ) { [self] _ in
            Task {
        ...
        let deleteAction = UIAction(
            ...
            image: utility.loadImage(named: "trashIcon", colors: [NCBrandColor.shared.iconImageColor]), //(named: "trash", colors: [.red]),

...
//        navigationController?.navigationBar.tintColor = NCBrandColor.shared.iconImageColor
        ...
        let editItem = UIBarButtonItem(image: NCUtility().loadImage(named: "actionSheetModify"), style: UIBarButtonItem.Style.plain, target: self, action: #selector(editItemAction(_:)))

...
//        }
    ...
    func setCommandView() {
        ...
        if filesName.count == 0 {
            ...
            // Label upload button
            uploadLabel.text = NSLocalizedString("_upload_", comment: "") + " \(filesName.count) " +  (filesName.count > 1 ? NSLocalizedString("_files_", comment: "") : NSLocalizedString("_file_", comment: ""))

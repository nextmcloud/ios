...
final class NCBrandOptions: @unchecked Sendable {
    ...
    var brand:                           String = "MagentaCLOUD Test"
    var brandUserAgent:             String = "MagentaCLOUD"
    var textCopyrightNextcloudiOS:       String = "MagentaCLOUD Test for iOS %@"
    var textCopyrightNextcloudServer:    String = "MagentaCLOUD Test Server %@"
    var loginBaseUrl:                    String = "https://magentacloud.com"
    ...
    // Capabilities Group
    var capabilitiesGroup:              String = "group.de.magentacloud.next.dev2.client.staging"
    var capabilitiesGroupApps:              String = "group.de.magentacloud.next.dev2.client.staging.apps"
